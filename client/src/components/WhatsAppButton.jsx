...
export default function WhatsAppButton() {
    ...
    return (
        ...
        >
            ...
            {/* Button */}
            <span className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#1DA851] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
